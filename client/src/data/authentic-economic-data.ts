...
export const analyticalReportsData = [
  {
    ...
    publisher: "Pearson",
    generalOverview: "Il manuale di Acemoglu rappresenta un approccio decisamente innovativo nell'insegnamento dell'economia politica, caratterizzato da una filosofia pedagogica che privilegia il metodo scientifico e l'analisi empirica rispetto alla tradizionale esposizione teorica. La struttura dell'opera rivela immediatamente questa impostazione metodologica: i primi tre capitoli sono dedicati esclusivamente ai fondamenti epistemologici e metodologici della disciplina, con particolare enfasi sull'ottimizzazione. L'architettura del testo si distingue per la sua ampiezza tematica e per l'integrazione sistematica di argomenti spesso trascurati nei manuali tradizionali. La presenza di capitoli dedicati a teoria dei giochi, economia dell'informazione, aste e contrattazioni, e economia sociale indica un approccio che abbraccia le frontiere più avanzate della ricerca economica contemporanea, rendendole accessibili agli studenti di livello introduttivo.",
    schoolsOfThought: "L'approccio di Acemoglu è profondamente radicato nella tradizione neoclassica moderna, ma con significative aperture verso le scuole di pensiero più innovative. Il capitolo 3 sull'ottimizzazione stabilisce chiaramente il paradigma della scelta razionale come fondamento dell'analisi, seguendo la tradizione che va da Samuelson alla moderna teoria microeconomica. Tuttavia, l'inclusione della teoria dei giochi (capitolo 13) e dell'economia dell'informazione (capitolo 16) indica un forte orientamento verso la 'nuova economia industriale' e l'economia dell'informazione sviluppata da autori come Tirole, Milgrom e Roberts. La presenza dell'economia sociale (capitolo 18) suggerisce un'apertura verso l'economia comportamentale e sperimentale, incorporando insights da Kahneman, Tversky e la scuola comportamentale. Sul fronte macroeconomico, la struttura dei capitoli finali indica un approccio che integra elementi della sintesi neoclassica con modelli di crescita endogena e teorie dello sviluppo istituzionale.",
    microMacroModels: "La struttura microeconomica del testo presenta una progressione sofisticata che va oltre i modelli standard. Il capitolo 3 introduce il framework dell'ottimizzazione vincolata come strumento unificante, che viene poi applicato sistematicamente ai comportamenti di consumatori (capitolo 5) e imprese (capitolo 6). Questa impostazione permette di trattare in modo coerente sia le scelte discrete che continue, fornendo agli studenti un toolkit analitico più potente rispetto ai tradizionali approcci grafici. I modelli di mercato seguono una progressione completa: dalla concorrenza perfetta (capitolo 7) al monopolio (capitolo 12), passando attraverso oligopolio e concorrenza monopolistica (capitolo 14). L'innovazione principale risiede nell'integrazione sistematica della teoria dei giochi (capitolo 13) come strumento per analizzare le interazioni strategiche, rendendo l'analisi dei mercati oligopolistici più rigorosa e realistica. La sezione macroeconomica rivela un approccio moderno che integra modelli di crescita (capitolo 21) con analisi delle fluttuazioni cicliche (capitoli 26-27). La presenza di capitoli specifici sul mercato del credito (capitolo 24) e sul sistema monetario (capitolo 25) indica l'utilizzo di modelli DSGE (Dynamic Stochastic General Equilibrium) o loro versioni semplificate, che costituiscono il mainstream della macroeconomia contemporanea.",
